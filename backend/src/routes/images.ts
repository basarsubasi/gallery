...
router.post('/', async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await pool.query(dbQuery, [
      uuid,
      image_url, // Store the URL instead of local filepath
      name,
      type,
      country,
      city,
...
/**
 * Route: GET /api/images/paginated
 * Description: Retrieve paginated images
 */
...
router.get(
  '/by-color',
  async (req: Request<{}, {}, {}, { color: string; page?: string; limit?: string }>, res: Response): Promise<void> => {
    try {
...
/**
 * Route: GET /api/images/:uuid
 * Description: Retrieve a specific image by UUID
 */
...
/**
 * Route: PUT /api/images/:uuid
 * Description: Update image details by UUID
 */
...
/**
 * Route: DELETE /api/images/:uuid
 * Description: Delete a specific image by UUID
 */
